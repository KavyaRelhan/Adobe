...
const UploadSection = ({ onFileUpload }) => {
  ...
  return (
    <div className="card-section">
      ...
      >
        <input ref={fileInputRef} type="file" multiple className="hidden-input" accept=".pdf" onChange={handleChange} />
        <div className="upload-zone-content">
          ...
          <span className="upload-text-secondary">or <button type="button" className="link-button">click to upload</button></span>
        </div>
      </div>
    </div>
  );
